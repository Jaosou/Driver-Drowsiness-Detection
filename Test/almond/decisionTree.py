...
data_test = pd.read_csv('C:/Project/End/Code/Data/train/almond/ear_data_for_train_almond_2.csv')
...
list(map(print_data, x_data_test,y_test_data, y_pred))

# ประเมินผล
evaluate_model(y_test_data, y_pred)
